...
10. **실적/전망 관련 질문 시 사업부별 매출 구조 필수 포함**: 사용자 질문이 기업의 실적, 전망, 재무 성과, 매출 분석 등과 관련된 경우, 반드시 '사업부별 매출 비중 및 구조 분석' 섹션을 포함하세요. 이 섹션에서는 주요 사업부별 매출 비중, 수익성, 성장성을 비교 분석해야 합니다.
11. **실적/전망 관련 질문 시 최근 분기 실적 포함**: 사용자 질문이 기업의 실적, 전망, 재무 성과, 매출 분석 등과 관련된 경우, '최근 분기 실적' 섹션을 포함하세요. 이 섹션에서는 분기별 매출액, 영업이익, 순이익 등의 항목이 있습니다.
12. **수출입데이터,잠정치 관련 질문 시 수출입,잠정치 포함**: 사용자 질문이 기업의 수출입,잠정치 관련 질문인 경우, '수출입 데이터' 섹션을 포함하세요. 이 섹션에서는 수출입,잠정치 데이터가 있습니다.
13. **핵심 요약 섹션의 description 작성**: 핵심 요약 섹션의 description에는 목차 나열을 피하고, 보고서의 주요 내용과 결론을 간략하게 요약하세요. 이어지는 각 섹션의 핵심 내용을 중심으로 투자자가 보고서 전체 내용을 빠르게 파악할 수 있도록 간결하게(100-150단어 내외) 작성하세요.
...
9. **환율변동** 섹션은 생성하지 않습니다. 단, 사용자의 질문이 환율변동과 관련이 있다면 생성합니다.
10. **기술적 분석, 차트 패턴 분석** 섹션은 생성하지 않습니다. 단, 사용자의 질문이 기술적 분석, 차트 패턴 분석과 관련이 있다면 생성합니다.
