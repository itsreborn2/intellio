    ...
    <section className="container flex min-h-[calc(100vh-3.5rem)] max-w-screen-2xl flex-col items-center justify-center space-y-8 py-24 text-center md:py-32">
      ...
      <div className="flex gap-6">
        <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
          ...
          <button className="relative rounded-full bg-background px-8 py-4 text-lg font-semibold leading-none tracking-tight inline-flex h-full w-full cursor-pointer items-center justify-center text-foreground hover:bg-accent/10 transition-colors">
            DocEasy
          </button>
        </span>
        <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
