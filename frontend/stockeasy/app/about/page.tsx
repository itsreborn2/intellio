              ...
              <div className="mb-6">
                ...
                <div className="px-2 py-2 bg-gray-50 rounded-md">
                  <p className="text-sm leading-relaxed">
                    스탁이지는 단순한 주식 정보 제공 서비스를 넘어, <strong>풍부한 실전 경험을 갖춘 전업 투자자들</strong>이 직접 개발한 혁신적인 투자 가이드 플랫폼입니다. 저희는 변동성이 큰 시장에서도 꾸준히 수익을 창출할 수 있는 핵심 전략으로, <strong>견고한 가치투자와 역동적인 추세추종을 정교하게 결합한 하이브리드 데이터</strong>를 제시합니다.<br/><br/>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-md p-3">
                    <h4 className="font-bold text-xs md:text-sm mb-2" style={{ color: 'oklch(0.4 0.03 257.287)' }}>스탁 AI</h4>
                    <p className="text-sm leading-relaxed">
                      스탁이지의 핵심 엔진인 <strong>스탁 AI</strong>는 단순 정보 검색 도구를 넘어, 데이터에 기반한 정교하고 심층적인 투자 분석을 제공하는 지능형 파트너입니다.<br/><br/>
                  ...
                  <div className="bg-gray-50 rounded-md p-3">
                    <h4 className="font-bold text-xs md:text-sm mb-2" style={{ color: 'oklch(0.4 0.03 257.287)' }}>RS 랭킹</h4>
                    <p className="text-sm leading-relaxed">
                  ...
                  <div className="bg-gray-50 rounded-md p-3">
                    <h4 className="font-bold text-xs md:text-sm mb-2" style={{ color: 'oklch(0.4 0.03 257.287)' }}>추세추종</h4>
                    <p className="text-sm leading-relaxed">
                  ...
                  <div className="bg-gray-50 rounded-md p-3">
                    <h4 className="font-bold text-xs md:text-sm mb-2" style={{ color: 'oklch(0.4 0.03 257.287)' }}>ETF/섹터</h4>
                    <p className="text-sm leading-relaxed">
                  ...
                  <div className="bg-gray-50 rounded-md p-3">
                    <h4 className="font-bold text-xs md:text-sm mb-2" style={{ color: 'oklch(0.4 0.03 257.287)' }}>밸류에이션</h4>
                    <p className="text-sm leading-relaxed">
