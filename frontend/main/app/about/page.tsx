...
export default function AboutPage() {
  return (
    <div className="container mx-auto pt-12 px-4 md:px-6">
      ...
      <div className="mt-6 prose prose-lg max-w-none text-muted-foreground">
        ...
        <h2 className="mt-10 text-3xl font-semibold tracking-tight text-foreground mb-4">우리는 누구인가?</h2>
        ...
        <h2 className="mt-10 text-3xl font-semibold tracking-tight text-foreground mb-4">우리가 하는 일</h2>
        ...
        <h2 className="mt-10 text-3xl font-semibold tracking-tight text-foreground mb-4">차별점</h2>
        <ul className="mt-4 list-disc space-y-3 pl-5 marker:text-sky-400">
        ...
        <h2 className="mt-10 text-3xl font-semibold tracking-tight text-foreground mb-4">비전과 목표</h2>
        ...
        <p className="my-24 text-3xl font-semibold text-center text-foreground/90">인텔리오와 함께, 스탁이지 AI가 열어주는 새로운 투자 기회를 경험해 보세요!</p>
