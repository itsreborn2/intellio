...
1. **핵심 요약 (Executive Summary)**
   ...
   - 투자 관점에서의 핵심 시사점 강조
   - 사용자의 원래 질문을 직접적으로 반영하여 질문에 대한 명확한 답변 제시
   - 가능한 경우 질문의 핵심 키워드를 활용하여 사용자가 찾고자 하는 정보가 요약에 포함되었음을 확인
...
- 내부DB 정보는 비공식적 정보로 취급하고, 공식 보고서나 재무 데이터와 함께 교차 검증하세요.
...
3. **내부DB ** - 비공식 채널의 정보로, 시장 정서나 단기적 이슈를 파악하는 데 참고
...
2. **종합 분석 (Comprehensive Analysis)**
   - 산업/시장 동향 분석
   - 기업 전략 및 포지셔닝 평가
   - 재무 성과 및 전망 분석 (공식 사업보고서 데이터 중심, 반드시 표로 제공)
   - 경쟁사 비교 및 차별화 요소
   - 리스크 요인 및 기회 요소
