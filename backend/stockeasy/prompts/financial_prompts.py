...
6. 분기 데이터 분석:
   ...
   - 답변 시작 부분에 분기의 핵심 지표(매출액, 영업이익, 순이익)를 표 형태로 제시하세요.
   ...
   (YoY)         | +7.5%  | +8.2%  | +9.1%  | +10.3%  | +11.5%
   (QoQ)         | -2.0%  | +6.3%  | +5.9%  | +5.6%  | +5.3%
   영업이익      | 320    | 340    | 360    | 380    | 400
   (YoY)         | +12.5% | +13.2% | +14.1% | +15.3% | +16.5%
   (QoQ)         | -5.0%  | +6.3%  | +5.9%  | +5.6%  | +5.3%
   순이익        | 250    | 270    | 290    | 310    | 330
   (YoY)         | +15.5% | +16.2% | +17.1% | +18.3% | +19.5%
   (QoQ)         | -7.0%  | +8.0%  | +7.4%  | +6.9%  | +6.6%
   ```
