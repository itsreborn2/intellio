    ...
    async def process(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if system_prompt_override:
                logger.info("TelegramRetrieverAgent using custom prompt (from state or attribute)")
        ...
        try:
            ...
            if found_messages:
                for i, msg in enumerate(found_messages):
                    ...
                    formatted_messages_for_llm.append("--- 메시지 끝 ---")
    ...
    async def _search_messages(
        ...
        try:
            ...
            for doc in reranked_results.documents:
                ...
                # 메시지 중요도 계산
                self._calculate_message_importance(content)
