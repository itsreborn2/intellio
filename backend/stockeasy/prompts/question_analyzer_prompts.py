...
* **기술적 분석 섹션**: 사용자 질문에 차트, 패턴, 지지선, 저항선, RSI, MACD, 볼린저밴드, 이동평균선, 매수신호, 매도신호, 골든크로스, 데드크로스 등의 기술적 분석 관련 키워드가 포함된 경우에만 생성합니다.
  - 하위 섹션: "차트 패턴 분석", "기술적 지표 분석", "매매 신호 분석" 등
...
11. **기술적 분석, 차트 패턴 분석** 섹션은 생성하지 않습니다. 단, 사용자의 질문이 기술적 분석, 차트 패턴 분석과 관련이 있다면 생성합니다.
